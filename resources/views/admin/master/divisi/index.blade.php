            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a href="{{ route('divisi.showformdivisi') }}" class="btn btn-success pull-right"><span
                                class="fa fa-plus"></span> Divisi</a>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($data as $val)
                                        <tr>
                                            ...
                                            <td>{{ $val->desc_direk }}</td>
                                            <td>{{ $val->created_at }}</td>
                                            <td style="width: 100pt">

                                                <a href="{{ route('divisi.showEditDivisi', ['id' => $val->id]) }}"
                                                    type="button" data-toggle="tooltip" title="edit" class="btn btn-primary btn-xs"><i
                                                        class="fa fa-edit"></i></a>
                                                        
                                                <a onclick="deleteDivisi('{{ $val->id }}')" type="button"
