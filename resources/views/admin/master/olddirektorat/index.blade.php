            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a href="{{ route('direktorat.showformdirek') }}" class="btn btn-success pull-right"><span
                                class="fa fa-plus"></span> Direktorat</a>
                    </div>
                                    ...
                                    @foreach ($data as $val)
                                        <tr>
                                            ...
                                            <td style="width: 100pt">
                                                ...
                                                <a href="{{ route('direktorat.showEditDirek', ['id' => $val->id]) }}"
                                                    type="button" data-toggle="tooltip" title="edit" class="btn btn-primary btn-xs"><i
                                                        class="fa fa-edit"></i></a>
                                                        
                                                <a onclick="deleteDirek('{{ $val->id }}')" type="button"
        ...
        function deleteDirek(val) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('direktorat.deleteDirek') }}",
                        type: "GET",
                        data: {
                            id: val
                        },
