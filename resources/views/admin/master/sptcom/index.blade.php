            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a href="{{ route('sptcom.list') }}?form=add" class="btn btn-success pull-right"><span
                                class="fa fa-plus"></span> Paramater</a>
                    </div>
                                    ...
                                    @foreach ($data as $val)
                                        <tr>
                                            ...
                                            <td style="width: 100pt">
                                                ...
                                                <a href="{{ route('sptcom.list') }}?form=edit&id={{ $val->id }}"
        ...
        function deleteCab(val) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('sptcom.deleteparam') }}",
                        type: "GET",
                        data: {
                            id: val
                        },
                        success: function(rs) {
                            msgBoxSweetBasic(rs.status, rs.message, rs.status,"{{ route('sptcom.list') }}");
                        },
                        error: function(rs) {
