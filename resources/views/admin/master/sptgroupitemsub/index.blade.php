            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a href="{{ route('sptgroupitemsub.showForm') }}" class="btn btn-success pull-right"><span
                                class="fa fa-plus"></span> Sub Group Item</a>
                    </div>
                                    ...
                                    @foreach ($data as $val)
                                        <tr>
                                            ...
                                            <td style="width: 100pt">
                                                ...
                                                <a href="{{ route('sptgroupitemsub.showFormEdit', ['subitem' => $val->subitem]) }}"
                                                    type="button" data-toggle="tooltip" title="edit" class="btn btn-primary btn-xs"><i
                                                        class="fa fa-edit"></i></a>
                                                        
                                                <a onclick="deleteSptGroupItemSub('{{ $val->id }}')" type="button"
...
@section('js')
    <script>
        function deleteSptGroupItemSub(val) {
            Swal.fire({
                title: "Are you sure?",
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('sptgroupitemsub.deleteSptgroupItemSub') }}",
                        type: "GET",
                        data: {
                            id: val
                        },
